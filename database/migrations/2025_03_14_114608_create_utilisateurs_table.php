...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('utilisateurs', function (Blueprint $table) {
            $table->engine = 'InnoDB'; // Assure-toi que le moteur de la table est bien InnoDB pour les clés étrangères.
            $table->id(); // L'ID est généré automatiquement comme clé primaire.
            $table->string('nom');
            $table->string('prenom');
