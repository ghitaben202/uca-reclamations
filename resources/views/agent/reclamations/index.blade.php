        ...
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            ...
            <div class="btn-group">
                <a href="{{ route('agent.reclamations.index', ['statut' => 'all']) }}" 
                   class="btn btn-sm {{ !request('statut') || request('statut') == 'all' ? 'btn-primary' : 'btn-outline-primary' }}">
                    Toutes
                </a>
                ...
                <a href="{{ route('agent.reclamations.index', ['statut' => 'clôturée']) }}" 
                   class="btn btn-sm {{ request('statut') == 'clôturée' ? 'btn-primary' : 'btn-outline-primary' }}">
                    Clôturées
                </a>
                <a href="{{ route('agent.reclamations.index', ['statut' => 'rejetée']) }}" 
                   class="btn btn-sm {{ request('statut') == 'rejetée' ? 'btn-primary' : 'btn-outline-primary' }}">
                    Rejetées
                </a>
            </div>
        </div>
